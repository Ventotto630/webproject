...
<table>
    <tr>
        <td class="center boldblack" colspan="3">申请步骤</td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td colspan="3" class="center boldblack">申请须知</td>
    </tr>
    <tr>
        <td colspan="3">
            ...
            <br>
            <label class="blue">
                3.如遇重要活动或极端天气等特殊情况，已审批的预约信息将被取消，请及时关注学校发布的相关提示。
            </label>
            <br>
            <label class="blue">
            ...
            <br>
            <label class="blue">
                2.校园分为开放区域和非开放区域。学生宿舍区、家属区和教学科研办公场所为非开放区域，不对参观者开放。未经允许，请勿入内。
            </label>
            <br>
            <label class="blue">
            ...
            <br>
            <label class="blue">
                5.禁止使用明火，禁止放飞高空漂浮物，禁止在水域内游泳、洗涤、垂钓、撒网、放生、捕捉伤害水生动植物和鸟禽等。
            </label>
            <br>
            <label class="blue">
...
<div class="container">
    <button class="button button1" onclick="location.href='home.jsp'">开始预约</button>
</div>
