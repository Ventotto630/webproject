    ...
    <div class="nav">
        <ul>
            <li class="list">
                <h2><i></i>本部门公务预约</h2>
                <div class="hide">
                    <h5><a href="#" onclick="loadPage('queryRezvtionPub.jsp')">查询</a></h5>
                    <h5><a href="#" onclick="loadPage('countRezvtionPub.jsp')">统计</a></h5>
                    <h5><a href="#" onclick="loadPage('../../DcheckServlet')">审核</a></h5>
                </div>
            </li>
            <li class="list">
                <h2 id="social" class="social"><i></i>社会预约</h2>
                <div class="hide">
                    <h5><a href="#" onclick="loadPage('../school/rezvtion/queryRezvtion.jsp')">查询</a></h5>
                    <h5><a href="#" onclick="loadPage('../school/rezvtion/countRezvtion.jsp')">统计</a></h5>
                </div>
            </li>
            <li class="list">
                <h2 id="pub" class="pub"><i></i>公务预约</h2>
                <div class="hide">
                    <h5><a href="#" onclick="loadPage('../school/rezv_public/queryRezvtionPub.jsp')">查询</a></h5>
                    <h5><a href="#" onclick="loadPage('../school/rezv_public/countRezvtionPub.jsp')">统计</a></h5>
